                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-6">
                            <div class="login-card">
                                <div class="card-body">
                                    <h2 class="login-header">Create New Account</h2>
                                                ...
                                                <div class="col-6"> <!-- Each button in half-width column -->
                                                    <a href="#" class="btn btn-google btn-lg w-50 text-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                            height="18" viewBox="0 0 24 24" class="me-2">
                                                            <path fill="#4285F4"
...
<br>
                                                    <div class="col-6">
                                                        <a href="#"
                                                            class="btn btn-facebook btn-lg w-50 text-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                                height="18" viewBox="0 0 24 24" class="me-2">
                                                                <path fill="#ffffff"
                                                                    d="M22.675 0h-21.35C.595 0 0 .595 0 1.325v21.351C0 23.404.595 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.323-.593 1.323-1.325V1.325C24 .595 23.404 0 22.675 0z" />
                                                            </svg>
