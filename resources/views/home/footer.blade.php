    ...
    <div class="footer-top section">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          {{-- <a href="#" class="logo">
            <img src="./assets/images/logo7.jpg" width="53" height="50"
              alt="Footcap logo">
          </a>
          ...
          <ul class="footer-list">
            ...
            <li>
              <a
                ...
                <span class="footer-link-text">Chat With Head of technical
                  Team</span>
              </a>
            </li>
            ...
            <li>
              <a href="mailto:footcap@help.com" class="footer-link">
                ...
                <span class="footer-link-text">kel254info@co.ke</span>
              </a>
            </li>
            ...
            <table class="footer-table">
              <tbody>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">8AM - 5 PM</td>
                </tr>
                ...
                <tr class="table-row">
                  <th class="table-head" scope="row">Thur:</th>
                ...
                <tr class="table-row">
                  ...
                  <td class="table-data">8AM - 12PM</td>
                </tr>
